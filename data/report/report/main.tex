...
% \usepackage[nottoc,notlot,notlof]{tocbibind}        % Bibliography in toc but unnumbered

% \DefineBibliographyStrings{english}{%
%   bibliography = {References},
% }

\newcommand{\code}[1]{\texttt{#1}}                  % Displaying a line of code using monospace
...
{\parindent 0 pt}
{\parindent 0 pt\thesistitle\par}
{\thesissubtitle\par}
{\textsc\thesisauthor\par}
{\thesisdepartment\par}
{Chalmers University of Technology\par}
% \vskip 3 pc
...
% Appendices
\begin{appendices}
\chapter{Audio files}\label{sec:app-files}
This thesis discusses auralisations and recordings, and throughout the text
figures of certain attributes of these sounds were shown.
The table on the next page lists the available sound files.
An archive with the audio files can be found online \cite{Rietdijk2017e}.
\begin{table}[H]
\centering
  \caption{Table with audio files.}
%   \label{table:listening:results:analysis}
\input{kappa/appendix-audio.tex}
\end{table}
\end{appendices}
