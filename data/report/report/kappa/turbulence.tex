...
Figures \ref{fig:turbulence:aircraft:parameters:correlation} and \ref{fig:turbulence:aircraft:parameters:variance} show the effect of each of these parameters on an auralisation of an "aircraft".
...
%     \centering
    ...
    \end{subfigure}
    \caption{The influence of the correlation length $L$. The variance of the dynamic refractive-index is fixed at $\SI{1e-5}{}$.}
...
%     \centering
    ...
    \begin{subfigure}{\textwidth}
        ...
        \caption{\SI{1e-7}{}}
    \end{subfigure}
    \caption{The influence of the variance of the dynamic refractive-index $\sigma_{\mu}^2$. The correlation length is fixed at \SI{1}{\meter}.}
