...
\cite{PureData2017}. Both are data flow programming languages where programs are
...
C++, no runtime is needed. Digital signals are modelled as discrete functions of
