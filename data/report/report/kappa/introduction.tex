...
% Aircraft noise prediction models like FLULA,
...
rooms, but also for the exterior sound of
...
With auralisation the audible sound of an object or environment is produced and
this allows studying the impact of that on humans and the development of improved descriptors.

\todo{refer to sonorus booklet}
\todo{Describe auralisation use cases}
The method can also be used as a communication tool for example when discussing
urban development. Typically noise contours are used to communicate how much
noise is present at locations. These are typically hard to interpret for
non-specialists, and they also give no insight in what the noise may sound like.
Lelystad airport in The Netherlands is expanding and residents living nearby
were initially presented with noise contours. Because they struggled with
interpreting the Netherlands Aerospace Centre (NLR) was asked with to help
residents understanding the implications by using auralisations at townhall
meetings \cite{Arntzen2015}.
...
directly, but will result in decorrelation or loss of self-coherence, and
therefore additional attenuation which may be noticeable. Furthermore, the phase
fluctuations can impact the interference between direct and (ground) reflected
sound.
...
apply this algorithm in auralisations.
\newline
\newline
...
\section{Limitations}
The goal is to develop a tool that can deliver auralisations that sound plausible.
