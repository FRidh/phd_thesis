...
On December \nth{17}, 1903, the Wright brothers made the first sustained and
...
mostly wood and fabric to monoplanes made of aluminium. Power of the engines
increased as well. Many aviation firsts occurred during this period, like the
...
ballistic missiles and the successful launch of the Sputnik 1 began the Space
...
Travelling for holidays requires passenger transport, and so does commerce, where
...
has changed over the years, rating aircraft noisier than before \cite{Babisch2009}.
...
of Europe, is an intergovernmental organisation and is tasked with \say{the
...
noise levels. However, an assumption or simplification like this disregards the
...
wind turbines \cite{Pieren2014,Heutschi2014},
...
town hall meetings \cite{Arntzen2015}.
...
While the sounds are often entirely generated, this is not necessarily always the
...
artificial or \say{perfect} \cite{Arntzen2014a}.
...
and auralisations of wind turbines were compared, cow bells were audible in the
...
based on data obtained from flights that occurred at Z\"{u}rich airport in 2013 and
2014.

The main data set consists of sound recordings at various positions nearby the
...
This extensive data set was used for the development for an aircraft noise
