...
\cite{Kirk2009,Schaffer2014}. \todo{write A-weighted instead of dB(A)}
...
% Aircraft noise can furthermore affect real estate prices

% more detailed on human response
...
\section{Limitations}
The goal is to develop a tool that can deliver auralisations that \todo{expand}
